...
{	
	...
	bReturn = CreateGLTexture( // plane texture
		"textures/fabric.jpg",
		"fabric");
	
	bReturn = CreateGLTexture( // sphere texture
		"textures/marble.jpg",
		"marble");

	bReturn = CreateGLTexture( // cylinder texture
...
void SceneManager::DefineObjectMaterials()
{
	...
	OBJECT_MATERIAL smoothMaterial;
	smoothMaterial.ambientColor = glm::vec3(0.2f, 0.3f, 0.4f);
	smoothMaterial.ambientStrength = 0.3f;
	smoothMaterial.diffuseColor = glm::vec3(0.3f, 0.2f, 0.1f);
	smoothMaterial.specularColor = glm::vec3(0.4f, 0.5f, 0.6f);
	smoothMaterial.shininess = 25.0;
	smoothMaterial.tag = "smooth";

	m_objectMaterials.push_back(smoothMaterial);
...
void SceneManager::RenderScene()
{
	...
	/****************************************************************/
	// Draw the cylinder mesh for the jar
	...
	// set the material for the next draw command
	SetShaderMaterial("smooth");

	// draw the mesh with transformation values
	m_basicMeshes->DrawCylinderMesh();

	/****************************************************************/
	// Draw the sphere mesh for the jar
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.0f, 5.2f,-0.5f);
	...
	/****************************************************************/
	// Draw the box mesh for the cup stand


	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(12.0f, 5.0f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 2.5f, -5.0f);
	...
	/****************************************************************/
	// Draw the box mesh for the book


	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(8.0f, 8.0f, 1.5f);
	...
	/****************************************************************/
	// Draw the tapered cylinder mesh for the cup 
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f, 7.0f, -5.0f);
	...
	/****************************************************************/
	// Draw the torus mesh for the cup 
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.5f, 6.0f, -4.5f);
	...
	/****************************************************************/
	// Draw the sphere mesh for the apple 
